...
seven_seg display_0 (
   .hex_digit(ahb_dmem_haddr[18:15]),
   .segments(HEX2)
);

seven_seg display_1 (
   .hex_digit(ahb_dmem_haddr[22:19]),
   .segments(HEX3)
);

seven_seg display_2 (
   .hex_digit(ahb_dmem_haddr[26:23]),
   .segments(HEX4)
);

seven_seg display_3 (
   .hex_digit(ahb_dmem_haddr[31:27]),
   .segments(HEX5)
);

endmodule: de10lite_scr1_original
