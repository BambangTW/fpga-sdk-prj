...
//==========================================================
// Wishbone wires for IMEM and DMEM
//==========================================================
logic [31:0] wb_imem_dat_i;
logic [31:0] wb_imem_adr_i;
...
// For now, tie these WB slave outputs to default values (like a stub slave).
assign wb_imem_dat_o = 32'd0;
assign wb_imem_ack_o = 1'b1;
assign wb_imem_err_o = 1'b0;

assign wb_dmem_dat_o = 32'd0;
assign wb_dmem_ack_o = 1'b1;
assign wb_dmem_err_o = 1'b0;

//==========================================================
// Replace AHB-Avalon bridges with AHB3Lite-to-WB bridges
//==========================================================

// IMEM Bridge Replacement
ahb3lite_to_wb i_ahb_imem (
    .clk_i        (cpu_clk),
    .rst_n_i      (soc_rst_n),

    // AHB3-Lite interface
    .sHADDR       (ahb_imem_haddr),
    .sHWDATA      (32'b0),        // Instruction memory typically read-only
    .sHWRITE      (1'b0),
    .sHSIZE       (ahb_imem_hsize),
    .sHBURST      (ahb_imem_hburst),
    .sHSEL        (1'b1),
    .sHTRANS      (ahb_imem_htrans),
    .sHREADY      (1'b1),         // Assuming always ready; adjust as needed
    ...
    // Wishbone interface - These need to connect to a Wishbone slave.
    .to_wb_dat_i  (wb_imem_dat_i),    // Master to Slave data
    ...
    .from_wb_dat_o(wb_imem_dat_o),    // Slave to Master data
    .from_wb_ack_o(wb_imem_ack_o),
    .from_wb_err_o(wb_imem_err_o)
);

// DMEM Bridge Replacement
ahb3lite_to_wb i_ahb_dmem (
    .clk_i        (cpu_clk),
    .rst_n_i      (soc_rst_n),
