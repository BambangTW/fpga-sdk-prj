...
// Master 0 targeting Slave 0 or Slave 1 based on address
wire [3:0] m0_wbd_tid_i = (m0_wbd_adr_i >= 32'hFFFF0000 && m0_wbd_adr_i <= 32'hFFFFFFFF) ? TARGET_SLAVE0 :
                          (m0_wbd_adr_i >= 32'hFF010000 && m0_wbd_adr_i <= 32'hFF010FFF) ? TARGET_SLAVE1 :
                          4'b0000;

// Master 1 targeting Slave 0 or Slave 1 based on address
wire [3:0] m1_wbd_tid_i = (m1_wbd_adr_i >= 32'hFFFF0000 && m1_wbd_adr_i <= 32'hFFFFFFFF) ? TARGET_SLAVE0 :
