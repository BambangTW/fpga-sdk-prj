...
// Internal signals
reg [31:0] addr_reg;    // Holds the address during transactions
reg [31:0] wb_data_reg; // Holds the Wishbone write data
...
always_comb begin
    ...
    // For half-word accesses, enable 2 bytes based on alignment
    if (wb_stb_i && !wb_we_i) begin // Handle non-word accesses
        case (wb_adr_i[1:0])
