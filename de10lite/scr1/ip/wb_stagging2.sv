...
logic [31:0] m_wbd_dat_i_ff; // Flopped version of m_wbd_dat_i
logic [31:0] m_wbd_adr_i_ff; // Flopped version of m_wbd_adr_i
logic [3:0]  m_wbd_sel_i_ff; // Flopped version of m_wbd_sel_i
logic        m_wbd_we_i_ff;  // Flopped version of m_wbd_we_i
logic        m_wbd_cyc_i_ff; // Flopped version of m_wbd_cyc_i
logic        m_wbd_stb_i_ff; // Flopped version of m_wbd_stb_i
logic [3:0]  m_wbd_tid_i_ff; // Flopped version of m_wbd_tid_i
logic [31:0] s_wbd_dat_i_ff; // Flopped version of s_wbd_dat_i
logic        s_wbd_ack_i_ff; // Flopped version of s_wbd_ack_i
logic        s_wbd_err_i_ff; // Flopped version of s_wbd_err_i
